...
const allShoes = [
  {
    querySelector: '.close-crocs-big',
    model: 'close-crocs',
    scale: 315,
  },
  {
    querySelector: '.violet-crocs-big',
    model: 'violet-crocs',
    scale: 32,
    rotate: -2,
  },
  {
    querySelector: '.retro-crocs-big',
    model: 'retro-crocs',
    scale: 1.3,
    rotate: -3,
    haveSpotLight: false,
  ...
  {
    querySelector: '.punk-black-crocs-big',
    model: 'punk-black-crocs',
    scale: 2.1,
  },
  {
    querySelector: '.punk-jean-crocs-big',
    model: 'punk-jean-crocs',
    scale: 2.1,
  },
  {
    querySelector: '.old-crocs-big',
    model: 'old-crocs',
    rotate: 1.7,
  },
  {
    querySelector: '.footwear-crocs-big',

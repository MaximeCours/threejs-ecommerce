...
const allBigPins = [
  {
    querySelector: '.pig-big',
    color: 0xde9ba3,
    texture: 'pig.png',
  },
  {
    querySelector: '.human-big',
    color: 0xcd9971,
    texture: 'human.png',
  },
  {
    querySelector: '.monster-big',
    color: 0x2d2a2d,
    texture: 'monster.png',
  },
  {
    querySelector: '.person-big',
    color: 0xeccda8,
    texture: 'person.png',
  },
  {
    querySelector: '.screamer-big',
    color: 0x4ca15f,
    texture: 'screamer.png',
  },
  {
    querySelector: '.flower-big',
    color: 0xffffff,
    texture: 'flower.jpg',
  },
  {
    querySelector: '.fish-big',
    color: 0xffffff,
    texture: 'fish.jpg',
  },
  {
    querySelector: '.clover-big',
    color: 0xffffff,
    texture: 'clover.jpg',
  },
  {
    querySelector: '.ladybug-big',
    color: 0xffffff,
    texture: 'ladybug.jpg',
  },
  {
    querySelector: '.cat-big',
    color: 0xffffff,
    texture: 'cat.jpg',
  },
  {
    querySelector: '.strawberry-big',
    color: 0xffffff,
    texture: 'strawberry.jpg',
  },
  {
    querySelector: '.donut-big',
    color: 0xffffff,
    texture: 'donut.jpg',
  },
]

for (let pin of allBigPins) {
